...
public class VendorPortalApplication extends WebMvcConfigurerAdapter{
    @Bean
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(VendorPortalApplication.class);
        app.run(args);
    }
